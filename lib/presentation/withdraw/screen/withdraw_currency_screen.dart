...
import 'package:hash_store/presentation/withdraw/widgets/withdraw_form.dart';
...
class _WithdrawCurrencyScreenState extends State<WithdrawCurrencyScreen> {
  ...
  void _submit() async {
    if (_formKey.currentState!.validate()) {
      await context
          .read<WithdrawCubit>()
          .withdrawRequest(_addressController.text, _amountController.text);
    }
  }
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            '${_withdrawCubit.getMaxBalance()} ${_withdrawCubit.selectedCurrency} Available',
                            style:
