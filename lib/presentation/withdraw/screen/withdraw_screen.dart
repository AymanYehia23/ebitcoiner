        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  context.read<WithdrawCubit>().selectCurrency(Currency.btc);
                  Navigator.of(context).pushNamed(AppRouter.withdrawCurrency);
                },
                child: Row(
                  children: [
                    SvgPicture.asset(
              ...
              InkWell(
                onTap: () {
                  context.read<WithdrawCubit>().selectCurrency(Currency.eth);
                  Navigator.of(context).pushNamed(AppRouter.withdrawCurrency);
                },
                child: Row(
                  children: [
              ...
              InkWell(
                onTap: () {
                  context.read<WithdrawCubit>().selectCurrency(Currency.rvn);
                  Navigator.of(context).pushNamed(AppRouter.withdrawCurrency);
                },
                child: Row(
                  children: [
              ...
              InkWell(
                onTap: () {
                  context.read<WithdrawCubit>().selectCurrency(Currency.ltct);
                  Navigator.of(context).pushNamed(AppRouter.withdrawCurrency);
                },
                child: Row(
                  children: [
